...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.published_on'
        db.alter_column(u'books_book', 'published_on', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Book.published_on'
        db.alter_column(u'books_book', 'published_on', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 17, 0, 0)))
