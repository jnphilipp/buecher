...
def statistics(request):
	...
	statistics['book_bindings'] = Book.objects.values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
	...
	statistics['purchased_bindings'] = Book.objects.filter(purchased_on__isnull=False).values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
	...
	statistics['sub_bindings'] = Book.objects.filter(purchased_on__isnull=False, read_on__isnull=True).values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
	...
	statistics['read_bindings'] = Book.objects.filter(read_on__isnull=False).values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
	...
	statistics['wishlist_bindings'] = Book.objects.filter(purchased_on__isnull=True).values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
	...
	statistics['year_purchased_binding_counts'] = Book.objects.filter(purchased_on__isnull=False, purchased_on__year=date.today().year).values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
	...
	statistics['month_purchased_binding_counts'] = Book.objects.filter(purchased_on__isnull=False, purchased_on__year=date.today().year, purchased_on__month=date.today().month).values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
	...
	statistics['year_read_bindings'] = Book.objects.filter(read_on__isnull=False, read_on__year=date.today().year).values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
	...
	statistics['month_read_bindings'] = Book.objects.filter(read_on__isnull=False, read_on__year=date.today().year, read_on__month=date.today().month).values('binding__binding').annotate(sum=Sum('price'), count=Count('binding')).order_by('binding')
